...
def generate_launch_description():
    ...
    plot_config_path = os.path.join(
        get_package_share_directory(package_name), "config", "plot_config.xml"
    )
    ...
    mpc = Node(
        package="lab2", executable="mpc_node.py", parameters=[{"use_sim_time": True}]
    )
    ...
    launch_description.add_action(mpc)
